        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              <div className="font-heading font-bold text-lg text-primary">Clarkson</div>
              <div className="font-accent text-sm text-muted-foreground -mt-1">Laundry & Shipping</div>
            </div>
          </Link>
